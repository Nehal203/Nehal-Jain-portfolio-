...
const Projects: React.FC = () => {
  ...
  const projects = [
    ...
    {
      title: 'Parikshit Travels',
      description: (
        <>
          A fully responsive travel website developed as a freelance project for a client under{" "}
          <a
            href="https://parikshittravels.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500 underline hover:text-blue-600"
          >
          ...
          . I handled both frontend and backend development using WordPress, creating a complete website with a clean and user-friendly design. The platform showcases tour packages like Sikkim and Gangtok, includes easy navigation, mobile responsiveness, and features like contact/WhatsApp integration to improve customer engagement and booking experience.
        </>
      ),
      image: '/images/parikshit.png',
      tech: ['WordPress'],
      category: 'Full Stack',
      github: 'https://parikshittravels.com/',
      demo: 'https://parikshittravels.com/',
    ...
    },
    {
      ...
      description: (
        <>
          A business website developed during my tenure at{" "}
          <span className="font-medium">The Threo Media</span>. The project was based on a pre-built WordPress theme provided by the company. I worked on customizing the content, layout, and sections according to client requirements, along with handling backend updates, page structuring, and ensuring responsiveness and smooth user experience.
          <br /><br />
          Live Demo:{" "}
          <a
            href="https://demo.smartbitdigital.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500 underline hover:text-blue-600"
          >
      ...
      image: '/images/smartbit.png',
      tech: ['WordPress', 'Theme Customization'],
      category: 'Full Stack',
      github: 'https://demo.smartbitdigital.com/',
      demo: 'https://demo.smartbitdigital.com/',
      icon: <MessageSquare size={24} />,
      featured: false
    },
    {
  ...
  featured: false
    ...
    },
    {
      ...
      tech: ['React'],
      category: 'Frontend',
      github: 'https://github.com/Nehal203/Payflex',
      demo: 'https://payflex-roan.vercel.app/',
