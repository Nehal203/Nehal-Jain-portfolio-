          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                <span className="block">Nehal</span>
              ...
              <div className="text-xl lg:text-2xl text-gray-300 mb-4 font-medium">
                Wordpress Developer | Shopify Developer | ReactJs Developer
              </div>

              <p className="text-lg text-gray-400 mb-8 max-w-lg leading-relaxed">
                Crafting scalable web applications with cutting-edge technologies.
                Specialized in wordpress, Shopify, React, Tailwindcss, HTML, CSS and JavaScript.
              </p>
            ...
            <div className="relative">
              <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 shadow-2xl">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-gray-400 text-sm ml-4">portfolio</span>
                </div>
                <div className="font-mono text-sm">
                  <div className="text-purple-400">const <span className="text-blue-400">developer</span> = {`{`}</div>
                  <div className="ml-4 text-gray-300">name: <span className="text-green-400">'Nehal Jain'</span>,</div>
                  <div className="ml-4 text-gray-300">role: <span className="text-green-400">'Frontend Developer'</span>,</div>
                  <div className="ml-4 text-gray-300">skills: [</div>
                  <div className="ml-8 text-green-400">'ReactJs', 'Javascript',</div>
                  <div className="ml-8 text-green-400">'MongoDB'</div>
