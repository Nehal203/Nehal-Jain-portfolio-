...
const Experience: React.FC = () => {
  const experiences = [
    ...
    {
  type: 'work',
  title: 'WordPress Developer | Shopify Developer',
  company: 'The Threo Media',
  location: 'Ahmedabad, Gujarat',
  period: 'Feb 2026 - Present',
  description: 'Worked on WordPress and Shopify projects, including theme customization, content updates, and managing both frontend and backend tasks. Built and maintained responsive websites, handled client requirements, and ensured smooth performance and user-friendly interfaces.',
  achievements: [
    'Customized WordPress themes and managed complete website structure for client projects.',
    'Worked on Shopify stores including product setup, collections, and UI improvements.',
    'Handled client-driven changes, content updates, and ensured mobile responsiveness.',
    'Improved overall website usability and navigation for better user experience.'
  ],
